...
main: main.c buffer.o client.o commands.o server.o parse.o print.o game.o
	gcc -Wall -g main.c buffer.o parse.o client.o commands.o game.o server.o print.o -o main
	rm -f *.o
